...
function setup () {
  ...
  inground=createSprite(200,height-90,400,20);
  inground.visible=false; 

  cacgrp=new Group();
  clogrp=new Group();
  
  end=createSprite(300,height/2-40,20,20);
  end.addImage(over)
  
  restart=createSprite(300,height/2,20,20);
  restart.addImage(rs);
  restart.scale=0.5;
}
...
function createcactus () {
  if (frameCount%90===0){
    cactus=createSprite(600,height-119,10,40);
    cactus.velocityX=-6;
